...
function cwcf_update_notice() {
	if ( ! defined( 'CWCFP_PLUGIN' ) && !get_option( 'cwcfp-update-notice-dismissed' ) ){
...
function cwcf_review_notice() {
	if ( ! defined( 'CWCFP_PLUGIN' ) && !get_option( 'cwcf-review-notice-dismissed' ) && get_option( 'cwcfp-update-notice-dismissed' ) ){
